if(isServer) then {
	...
	/* AI CONFIG */
		...
		ai_gear0					= [["ItemBandage","ItemBandage","ItemPainkiller"],["ItemKnife","ItemRadio"]];
	...
	/* WAI MISSIONS CONFIG */
		...
		wai_mission_spread			= 450;								// make missions spawn this far apart from one another and other markers
