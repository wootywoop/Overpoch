...
class CfgBuildingLoot {
	...
	class HeliCrash: Default {
		...
		lootType[] = {
			...
			{"militaryclothes","militaryclothes",0.2},
			{"militaryammo","militaryammo",0.2}
		};
	};
	...
	class Military: Default {
		...
		lootType[] = {
			...
			{"ItemFlashlightRed","military",0.2},
			{"ItemKnife","military",0.2},
			{"ItemGPS","weapon",0.2},
			{"ItemMap","military",0.2},
			{"militarybackpacks","militarybackpacks",0.2},
			{"","medical",0.2},
			{"","generic",0.2},
			{"","military",0.9},
	...
	class IndustrialMilitary: Default {
		...
		lootType[] = {
			...
			{"ItemGPS","weapon",0.2},
			{"PartVRotor","magazine",0.2},
			{"PartFueltank","magazine",0.2},
			{"PartEngine","magazine",0.2},
			{"PartGlass","magazine",0.2},
			{"militarybackpacks","militarybackpacks",0.2},
			{"","medical",0.2},
			{"","generic",0.25},
			{"","military",0.9},
	...
	class MilitarySpecial: Default {
		...
		lootType[] = {
			...
			{ "submachinegun", "cfglootweapon", 0.2 },
			{"AmmoBoxSmall_556","object",0.2},
			{"AmmoBoxSmall_762","object",0.2},
			{"Binocular","weapon",0.01},
			...
			{"","generic",0.3},
			{"","military",0.9},
			{"machinegunammo","machinegunammo",0.2},
			{"militaryclothes","militaryclothes",0.2},
			{"NVGoggles","weapon",0.2}
		};
		lootTypeSmall[] = {
			{ "pistols","cfglootweapon",0.2 },
			{ "AmmoBoxSmall_556","object",0.2 },
			...
			{ "","generic",0.2},
			{ "","military",0.9 },
			{ "5Rnd_86x70_L115A1","magazine",0.2},
			{ "10Rnd_127x99_m107","magazine",0.2},
			{ "machinegunammoexpl","single",0.2 },
			{ "militaryclothes","single",0.2 },
			{ "NVGoggles","weapon",0.04 },
			{ "100Rnd_762x54_PK","magazine",0.2 }
		};
	};
