...
if (isServer) then {
	...
	_cargoMansAin = 0.8;	//Ain of the cargo ocupants, from 0 to 1
	_turretMansAin = 0.9;	//Ain ot the turret operators, from 0 to 1
	...
	_donn_delete_body_time = 1200;	//Time in seconds to delete a dead AI body	
