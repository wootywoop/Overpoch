...
_spawnCrate addWeaponCargoGlobal ["Binocular_Vector", 10];
...
_spawnCrate addWeaponCargoGlobal ["ItemGPS", 10];
...
_spawnCrate addWeaponCargoGlobal ["NVGoggles", 10];
...
_spawnCrate addMagazineCargoGlobal ["ItemBloodbag", 50];
_spawnCrate addMagazineCargoGlobal ["ItemBriefcase100oz", 100];
_spawnCrate addMagazineCargoGlobal ["ItemBriefcaseEmpty", 10];
_spawnCrate addMagazineCargoGlobal ["ItemBriefcase_Base", 100];
...
_spawnCrate addMagazineCargoGlobal ["ItemSodaMdew", 50];
_spawnCrate addMagazineCargoGlobal ["PartEngine", 20];
_spawnCrate addMagazineCargoGlobal ["PartFueltank", 20];
_spawnCrate addMagazineCargoGlobal ["PartGeneric", 20];
_spawnCrate addMagazineCargoGlobal ["PartGlass", 20];
_spawnCrate addMagazineCargoGlobal ["PartVRotor", 20];
_spawnCrate addMagazineCargoGlobal ["PartWheel", 20];
