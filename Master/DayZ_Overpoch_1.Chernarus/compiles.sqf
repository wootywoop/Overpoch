...
if (!isDedicated) then {
	...
	FillSkinList  = compile preprocessFileLineNumbers "ZSC\skins\getList.sqf";
	ApplySkinList  = compile preprocessFileLineNumbers "ZSC\skins\changeClothes.sqf";
	...
	player_switchModel  = 		compile preprocessFileLineNumbers "ZSC\skins\player_switchModel.sqf";
	...
	player_wearClothes  = 		compile preprocessFileLineNumbers "ZSC\skins\player_wearClothes.sqf";
