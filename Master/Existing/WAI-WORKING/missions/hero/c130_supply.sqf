...
_hint = parseText format["<t align='left' color='#D60000' shadow='2' size='1.75'>New Mission:</t><br/><t align='left' color='#FFFFF9F'>A C-130 is dropping off supplies to a Jungle task force!</t>"];
...
diag_log 		format["WAI: [Mission:[Hero] C-130 Supply Drop]: Starting... %1",_position];

[_mission,_position,"Extreme","C-130 Supply Drop","MainHero",true] call mission_init;

	//Troops
	_rndnum 	= (3 + round(random 1));
	[[(_position select 0) -100, (_position select 1) +100, 0],_rndnum,"Extreme","Random",3,"Random","Bandit","Random","Bandit",_mission] call spawn_rpg;
	[[(_position select 0) -100, (_position select 1) +100, 0],_rndnum,"Extreme","Random",3,"Random","Bandit","Random","Bandit",_mission] call spawn_rpg;
	[[(_position select 0) +100, (_position select 1) -100, 0],_rndnum,"Extreme","Random",3,"Random","Bandit","Random","Bandit",_mission] call spawn_rpg;
	[[(_position select 0) +100, (_position select 1) -100, 0],_rndnum,"Extreme","Random",3,"Random","Bandit","Random","Bandit",_mission] call spawn_rpg;
	[[(_position select 0) +100, (_position select 1) +100, 0],_rndnum,"Extreme","Random",3,"Random","Bandit","Random","Bandit",_mission] call spawn_rpg;
	...
	[[(_position select 0) -100, (_position select 1) -100, 0],_rndnum,"Extreme","Random",3,"Random","Bandit","Random","Bandit",_mission] call spawn_rpg;
	[[(_position select 0) -100, (_position select 1) -100, 0],_rndnum,"Extreme","Random",3,"Random","Bandit","Random","Bandit",_mission] call spawn_rpg;
	[[_position select 0,_position select 1,0],_rndnum,"Extreme","Random",3,"Random","Bandit","Random","Bandit",_mission] call spawn_stinger;
	[[_position select 0,_position select 1,0],_rndnum,"Extreme","Random",3,"Random","Bandit","Random","Bandit",_mission] call spawn_stinger;
	...
	_complete = [
		...
		"A C-130 is dropping off supplies to a Jungle task force!",	// mission announcement
		"The C-130 supplies have been captured!",							// mission success
		"The Bandits got away with the cargo"										// mission fail
	...
	diag_log format["WAI: [Hero] c-130 supply drop ended at %1",_position];
