if(isServer) then {
	...
	//Troops
	[[(_position select 0) +100, (_position select 1) -100, 0],3,"Medium",["Random","AT"],4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
	[[(_position select 0) -100, (_position select 1) -100, 0],3,"Medium","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
