if(isServer) then {
	...
	_hint = parseText format["<t align='left' color='#D60000' shadow='2' size='1.75'>New Mission:</t><br/><t align='left' color='#FFFFF9F'>A jungle task force have set up a Communications Center! Go and ambush it to make it yours!</t>"];
	...
	if(_complete) then {
		[_crate,[26,ai_wep_box],[8,crate_tools_sniper],[25,crate_items_high_value],[1,crate_backpacks_large],[100,ammo_list]] call dynamic_crate;
	};
