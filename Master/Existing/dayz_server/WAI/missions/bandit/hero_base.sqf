if(isServer) then {
	...
	_hint = parseText format["<t align='left' color='#00FF11' shadow='2' size='1.75'>New Mission:</t><br/><t align='left' color='#FFFFF9F'>Heroes have setup a heavily fortified base, are you bandit enough to take them down?</t>"];
	...
	if(_complete) then {
		[_crate,[20,ai_wep_box],[8,crate_tools_sniper],[3,crate_items_high_value],[1,crate_backpacks_large],[100,ammo_list]] call dynamic_crate;
	};
