...
/*  LOW ADMIN HERE        */ _LAdmins = ["76561198037761124","0","0"]; //do not have a , at the end.
/*  NORMAL ADMIN HERE     */ _NAdmins = ["0","0","0"]; //do not have a , at the end.
/*  SUPER ADMIN HERE      */ _SAdmins = ["76561198003411083","76561198128539208","76561198085299917","76561198186075906"]; //do not have a , at the end.
...
_ALLOWED_Dialogs = [-1,106,2200,6900,6901,6902,6903,420420,41144,711194,666,667,55510];
...
[
	...
	"s_player2865_copyToKey","SP_refuel_action","SP_repair_action","SP_rearm_actions","s_player_setVectorsReset","s_player_setVectorsForward",
